...
class KalshiClient {
  ...
  /**
   * Sign API request with credentials
   */
  _getHeaders() {
    return {
  ...
  async createOrder(params) {
    try {
      const payload = {
        ...
        yes_price: params.yes_price, // price as integer (cents)
  ...
  /**
   * Get leaderboard (public data - no auth needed)
   */
  ...
  /**
   * Mock top traders for demo/testing
   */
  _getMockTopTraders() {
    return [
      {
